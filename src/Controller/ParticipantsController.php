...
class ParticipantsController extends AbstractController
{
    ...
    /**
     * @Route("/events/{id}/participants/add/profile/{uniqueID}", name="add_new_participants_event")
     */
    public function index(CountriesRepository $countriesRepository, SubProfileRepository $subProfileRepository, SessionInterface $session, Events $event, $uniqueID,ProfileRepository $profileRepository,Request $request, UserRepository $userRepository, TranslatorInterface $translator , UserPasswordEncoderInterface $passwordEncoder ): Response
    {
