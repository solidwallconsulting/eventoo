...
class NotesController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/{idClient}", name="notes_delete", methods={"POST"})
     */
    public function delete(Request $request, Notes $note, $idClient): Response
    {
        ...
        return $this->redirectToRoute('clients_show', ['id'=>$idClient], Response::HTTP_SEE_OTHER);
    }
}
